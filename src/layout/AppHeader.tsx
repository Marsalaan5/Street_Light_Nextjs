    ...
    <header className="sticky top-0 z-40 flex w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <motion.div className="hidden lg:block" initial={{ opacity: 0, y: -6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.05 }}>
            <form>
              <div className="relative">
                <span className="absolute -translate-y-1/2 left-4 top-1/2 pointer-events-none">
        ...
        <div className="hidden lg:flex items-center justify-end w-full gap-4 py-4">
          {rightContent}
        </div>

        {/* Mobile — genuinely slides open/closed now */}
        <AnimatePresence initial={false}>
          {isApplicationMenuOpen && (
            ...
            >
              <div className="flex items-center justify-between gap-4 px-5 py-4 shadow-theme-md">
                {rightContent}
              </div>
            </motion.div>
          )}
