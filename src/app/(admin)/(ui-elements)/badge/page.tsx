...
export const metadata: Metadata = {
  title: "Next.js Badge | Street Light Management System - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Street Light Management System - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
