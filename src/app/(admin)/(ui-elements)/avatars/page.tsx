...
export const metadata: Metadata = {
  title: "Next.js Avatars | Street Light Management System - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Street Light Management System - Next.js Tailwind CSS Admin Dashboard Template",
};
