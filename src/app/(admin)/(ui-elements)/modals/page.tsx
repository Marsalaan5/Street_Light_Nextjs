...
export const metadata: Metadata = {
  title: "Next.js Modals | Street Light Management System - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Street Light Management System - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
